...
- Cover state: `assets/design-qa-cover.png`
- Open spread, default viewport (1280 × 720): `assets/design-qa-open.png`
- Open spread, reference viewport (2048 × 1229): `assets/design-qa-open-reference-viewport.png`
- Side-by-side comparison: `assets/design-qa-comparison.png`
...
- Implementation: `assets/design-qa-rounded-spread.png` at 1157 × 806 CSS pixels and 1× density.
- Turning-state evidence: `assets/design-qa-rounded-turning.png` at 1157 × 806 CSS pixels and 1× density.
- Same-size comparison: `assets/design-qa-rounded-comparison.png`.
...
3. Post-fix evidence: `assets/design-qa-rounded-spread.png` shows the curved crown and recessed seam; `assets/design-qa-rounded-turning.png` shows the turning sheet covering the seam instead of the seam drawing over the sheet.
...
- Open-book evidence: `assets/design-qa-cover-underlay.png` (1280 × 720 CSS pixels, 1× density).
- Paper-control evidence: `assets/design-qa-paper-panel.png` (1280 × 720 CSS pixels, 1× density).
- Side-by-side comparison: `assets/design-qa-cover-comparison.png`; the reference was center-cropped to 16:9 and normalized to 1280 × 720 before comparison.
...
3. Post-fix evidence: `assets/design-qa-cover-underlay.png` shows the exposed cover perimeter; `assets/design-qa-paper-panel.png` shows the neutral 0% default and working control.
...
- Turning-state evidence: `assets/design-qa-travelling-shadow.png` and `assets/design-qa-travelling-shadow-early.png` at 1280 × 720 CSS pixels and 1× density.
...
- Open-spread evidence: `assets/design-qa-headband-final.png` at 1280 × 720 CSS pixels and 1× density.
- Turning-state evidence: `assets/design-qa-headband-turning.png` at 1280 × 720 CSS pixels and 1× density.
- Focused comparison: `assets/design-qa-headband-comparison.png`; it contains only the top book edge and excludes the document's personal content.
...
- Open-spread evidence: `assets/design-qa-fullscreen-reader-final.png` at 1280 × 720 CSS pixels and 1× density.
...
- Updated evidence: `assets/design-qa-reduced-scale.png` at 1280 × 720 CSS pixels and 1× density.
...
- Final evidence: `assets/design-qa-reader-safe-area-final.png`.
...
- Final interaction evidence: `assets/design-qa-pdf-tools.png`.
